...
if(function_exists('get_field') && class_exists('VideoUrlParser') && get_field('product_video_url')) {
  ...
  $video_button_html = '<a href="#" data-type="video" data-like-id="<?php echo get_the_ID() ?>" data-size="960x640" data-video=\'<div class="wrapper"><div class="video-wrapper"><iframe class="pswp__video" width="1920" height="1080" src="'.esc_url($video_url).'" frameborder="0" allowfullscreen></iframe></div></div>\'><div><i class="music-and-multimedia-play-button"></i></div></a>';
}
