...
class Elementor_Banner_Liquid_Slider_Widget extends Widget_Base {
  ...
  public function get_script_depends() {
    if (\Elementor\Plugin::$instance->editor->is_edit_mode() || \Elementor\Plugin::$instance->preview->is_preview_mode()) {
      return ['pt-liquidSlider', 'gsap', 'swiper', 'pt-youtube-video', 'banner-liquid-slider-handler'];
    }

    $scripts = ['pt-liquidSlider', 'gsap', 'swiper', 'pt-youtube-video', 'banner-liquid-slider-handler'];
    return $scripts;
  }
  ...
  protected function get_video_block($atts) {
    if (!$atts['video_url']) {return false;}
    $video_player = \VideoUrlParser::get_player($atts['video_url']);
    ?>
