...
class Elementor_Gallery_External_Link_Widget extends Widget_Base {
  ...
  public function get_script_depends() {
    if (Plugin::$instance->editor->is_edit_mode() || Plugin::$instance->preview->is_preview_mode()) {
      return ['gallery-external-link-handler', 'swiper-6.1.1', 'isotope', 'pt-scattered-portfolio', 'flipster', 'pt-load-posts', 'owl-carousel'];
    }
  ...
  protected function set_project_object($atts, $index) {
    $this->project = (object) [
      ...
      'title' => $atts['title'],
      'desc' => $atts['desc'],
      'get_image_original' => yprm_get_image($atts['image']['id'], 'array', 'full'),
      'get_image_html' => yprm_get_image($atts['image']['id'], 'img', $this->settings['thumb_size_size']),
      'get_image_bg' => yprm_get_image($atts['image']['id'], 'bg', $this->settings['thumb_size_size']),
      'get_image_array' => yprm_get_image($atts['image']['id'], 'array', $this->settings['thumb_size_size']),
    ];
