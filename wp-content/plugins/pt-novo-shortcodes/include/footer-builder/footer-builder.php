      ...
      add_filter('single_template', array($this, 'content_template'));
		...
		public function settings_fields() {
			...
			register_field_group(array(
				...
				'title' => esc_html__('Footer Settings', 'morave'),
				'fields' => array(
					array(
						'key' => 'field_2dec8e2eb269',
						'label' => esc_html__('Footer Background Color', 'morave'),
						'name' => 'footer_bg_color',
						'type' => 'color_picker',
					),
					array(
						'key' => 'field_59450627fa7e',
						'label' => esc_html__('Footer Text Color', 'morave'),
          ...
          array (
            ...
            'label' => esc_html__('Scroll Up Button', 'morave'),
          ...
          array (
            ...
            'label' => esc_html__('Decor Memphis', 'morave'),
            'name' => 'footer_decor',
            'type' => 'radio',
            'choices' => array (
              'show' => esc_html__('Show', 'novo'),
        ...
        $block_css[] = 'hide-decor';
          ...
          <?php if(class_exists('Elementor\Plugin') && Elementor\Plugin::$instance->documents->get( $id )->is_built_with_elementor()) {
            ...
            if(function_exists('visual_composer')) {
              $css = visual_composer()->parseShortcodesCustomCss($post_data->post_content);
