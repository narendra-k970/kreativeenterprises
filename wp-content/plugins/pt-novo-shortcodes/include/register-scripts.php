...
wp_register_script('swiper-6.1.1', plugins_url('pt-novo-shortcodes') . '/assets/js/swiper.min.js', array('jquery', 'pt-scripts'), '6.1.1', true);
...
wp_register_script('draggable', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/3.5.1/Draggable.min.js', array('gsap'), '3.4.2', true);
